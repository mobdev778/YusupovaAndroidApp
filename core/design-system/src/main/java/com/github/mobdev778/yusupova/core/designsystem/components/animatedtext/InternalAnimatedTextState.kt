...
import com.github.mobdev778.yusupova.core.designsystem.components.animatedtext.figure.Figure
import com.github.mobdev778.yusupova.core.designsystem.components.animatedtext.figure.FigureBuilder
import com.github.mobdev778.yusupova.core.designsystem.components.animatedtext.figure.Point
import kotlinx.coroutines.delay

@Suppress("TooManyFunctions")
internal data class InternalAnimatedTextState(
    ...
    fun reset(): InternalAnimatedTextState {
        bitmap?.recycle()
        bitmap = null
    ...
    suspend fun nextState(): InternalAnimatedTextState {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as InternalAnimatedTextState
